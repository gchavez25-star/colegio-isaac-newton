...
const DIRECTIVOS = [
  {
    ...
    "Ingeniera de Sistemas, con mención en Negocios y Tecnologías de la Información",
    "Colegiada CIP 167515",
    "Diploma en Gestión de Proyectos",
    "Diploma en Marketing Estratégico, Relaciones Públicas y Comunicación Corporativa",
  ...
  },
  {
    ...
    cargo: "Director",
    profesion: "Magíster en Administración Educativa",
    imagen: "/Comunidad/Directivos/SOTO COLLAZOS RICARDO RAUL.optimized.jpg",
    email: "rsoto@inewton.edu.pe",
    linkedin: "#",
    trayectoria: [  "Segunda Especialidad en Neuroeducación",
    "Especialista en Dirección de Instituciones Educativas",
    "Diplomado en Diseño Universal para el Aprendizaje (DUA)",
    "Especialista en Gestión de Habilidades Emocionales",
    "Especialista en Evaluación Formativa y Currículo Nacional"],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    "Experiencia en coordinación académica y gestión educativa",
    "Capacitación en currículo nacional y herramientas digitales",
    "Docente de Computación e Informática en nivel Primaria"
    ],
  },
];
