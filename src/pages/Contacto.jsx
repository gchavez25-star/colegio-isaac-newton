...
${formData.mensaje}
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* HERO SECTION */}
      <section className="relative min-h-[500px] overflow-hidden bg-[#013055] md:min-h-[560px]">
        <img
          src="/Contacto/Contacto.optimized.webp"
          alt="Estudiante comunicándose con el colegio"
          className="absolute inset-0 h-full w-full object-cover object-[64%_center]"
          fetchPriority="high"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#013055]/95 via-[#013055]/72 to-[#013055]/20" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#013055]/45 via-transparent to-[#013055]/20" />

        <div className="container relative z-10 mx-auto flex min-h-[500px] items-center px-6 py-20 md:min-h-[560px]">
          <div className="max-w-3xl">
            <motion.p
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
              className="mb-5 inline-flex rounded-full bg-white/10 px-5 py-2 text-sm font-bold uppercase tracking-[0.18em] text-[#fccc00] backdrop-blur-sm"
            >
            ...
            <motion.h1
              ...
              className="font-anton text-5xl leading-none text-white drop-shadow-xl md:text-7xl lg:text-8xl"
            >
              Contáctanos
            </motion.h1>
            ...
            <motion.p
              ...
              className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/90 md:text-2xl"
            >
              Resolvemos tus consultas sobre admisión, campus, horarios y
              servicios del Colegio Isaac Newton.
            </motion.p>
            ...
            >
              <a
                ...
                className="inline-flex items-center justify-center rounded-lg bg-[#fccc00] px-7 py-4 font-bold text-[#013055] transition hover:bg-[#ffdc2e]"
              >
                Enviar mensaje
              </a>
              <a
                href="#campus-contacto"
                className="inline-flex items-center justify-center rounded-lg border border-white/30 bg-white/10 px-7 py-4 font-bold text-white backdrop-blur-sm transition hover:bg-white/15"
              >
                Ver campus
              </a>
            </motion.div>
      ...
      {/* Mapa de ubicación */}
      <section id="campus-contacto" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
